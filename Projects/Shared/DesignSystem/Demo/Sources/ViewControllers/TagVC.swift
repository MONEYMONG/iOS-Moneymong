...
final class TagVC: UIViewController {
  ...
  private func setupView() {
    ...
    tag4.configure(title: "회원", titleColor: Colors.White._1, backgroundColor: Colors.Gray._7)
    tag5.configure(title: "총무", titleColor: Colors.Blue._4, backgroundColor: Colors.Blue._1)

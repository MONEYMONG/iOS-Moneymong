...
final class MemberCell: UITableViewCell, ReusableView {
  ...
  func configure(member: Member, role: Member.Role) {
    ...
    switch member.role {
    case .member:
      roleView.configure(title: "회원", titleColor: Colors.White._1, backgroundColor: Colors.Mint._3)
    case .staff:
      roleView.configure(title: "총무", titleColor: Colors.White._1, backgroundColor: Colors.Blue._4)
    }

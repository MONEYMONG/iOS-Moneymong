...
final class SelectionVC: UIViewController {
  ...
  private let selectionView1 = SelectionView(titles: ["지출", "수입"], type: .round)
  private let selectionView2 = SelectionView(titles: ["전체", "지출", "수입"], type: .capsule)
  private let selectionView3 = SelectionView(titles: ["1학년", "2학년", "3학년", "4학년", "5학년"], type: .round)
